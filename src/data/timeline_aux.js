export default [
    ...
    },
    {
     ...
     },
     {
        ...
        details:
          'As a part-time Teaching Assistant at Coding Dojo, I have tutored over 100 online students, making a significant impact on their transition into full-stack development. I support learning in various technologies such as Python and Flask, Java and Spring Boot, and the MERN stack. Through guidance and support, I have contributed to the success of students in achieving their software development career goals.',
      },
 ]